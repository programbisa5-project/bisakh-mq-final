...
export type StatusUpdateQueue = "Menunggu" | "Disetujui" | "Ditolak" | "Selesai" | "Gagal";
export type JenisPerubahanQueue = "GANTI_ID" | "GANTI_NAMA" | "GANTI_NOMOR" | "UBAH_STATUS";
...
export type KeputusanHadiah = "Belum Diputuskan" | "Diberikan" | "Tidak Diberikan";
...
export interface Database {
  public: {
    Tables: {
      bisakh_peserta: { Row: BisakhPeserta; Insert: Partial<BisakhPeserta>; Update: Partial<BisakhPeserta> };
      angkatan: { Row: Angkatan; Insert: Partial<Angkatan>; Update: Partial<Angkatan> };
      peserta_kelas: { Row: PesertaKelas; Insert: Partial<PesertaKelas>; Update: Partial<PesertaKelas> };
      mq_user: { Row: MqUser; Insert: Partial<MqUser>; Update: Partial<MqUser> };
      pekan: { Row: Pekan; Insert: Partial<Pekan>; Update: Partial<Pekan> };
      kegiatan: { Row: Kegiatan; Insert: Partial<Kegiatan>; Update: Partial<Kegiatan> };
      pemenang: { Row: Pemenang; Insert: Partial<Pemenang>; Update: Partial<Pemenang> };
      riwayat_peserta: { Row: RiwayatPeserta; Insert: Partial<RiwayatPeserta>; Update: Partial<RiwayatPeserta> };
      update_queue: { Row: UpdateQueue; Insert: Partial<UpdateQueue>; Update: Partial<UpdateQueue> };
      soal: { Row: Soal; Insert: Partial<Soal>; Update: Partial<Soal> };
      soal_usage: { Row: SoalUsage; Insert: Partial<SoalUsage>; Update: Partial<SoalUsage> };
      sertifikat_link: { Row: SertifikatLink; Insert: Partial<SertifikatLink>; Update: Partial<SertifikatLink> };
      template: { Row: TemplateRow; Insert: Partial<TemplateRow>; Update: Partial<TemplateRow> };
      materi: { Row: Materi; Insert: Partial<Materi>; Update: Partial<Materi> };
      pembuka_muhadharah: { Row: PembukaMuhadharah; Insert: Partial<PembukaMuhadharah>; Update: Partial<PembukaMuhadharah> };
      sop_document: { Row: SopDocument; Insert: Partial<SopDocument>; Update: Partial<SopDocument> };
      sop_rule: { Row: SopRule; Insert: Partial<SopRule>; Update: Partial<SopRule> };
    };
    ...
    Functions: {
      ...
      soal_tersedia: { Args: { p_soal_id: number; p_angkatan_id: number }; Returns: boolean };
      catat_penggunaan_soal: {
        Args: { p_soal_id: number; p_angkatan_id: number; p_catatan: string | null };
        Returns: unknown;
      };
      proses_update_queue: {
        Args: { p_queue_id: number; p_keputusan: string; p_catatan: string | null };
        Returns: unknown;
      };
...
/** Nama tabel yang valid — pakai ini, bukan `string` polos, kalau butuh nama tabel dinamis. */
