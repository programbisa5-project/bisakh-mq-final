...
// Halaman ini di-guard dua kali secara sadar:
// (1) tidak muncul di sidebar untuk role "mq" (lihat AppLayout) — ini
//     hanya UX, bukan keamanan.
// (2) requireSuperadmin() di bawah ini — guard SERVER-SIDE eksplisit
//     yang benar-benar mencegah akses langsung ke URL ini, terlepas dari
//     RLS mq_user (yang belum divalidasi mengizinkan SELECT untuk role
//     apa saja — lihat AUDIT.md temuan #4). MQ yang mengetik URL ini
//     langsung akan dialihkan ke /dashboard sebelum data user manapun
//     sempat di-query.
