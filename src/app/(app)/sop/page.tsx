...
import { SopDocumentForm } from
"@/components/sop/SopDocumentForm";
...
<div>
<p className="text-xs text-ink/40">{r.kode_rule} · {r.kategori ??
"Tanpa kategori"}</p>
<p className="font-medium text-ink">{r.judul}</p>
</div>
<div className="flex items-center gap-2">
{r.prioritas != null ? <Badge>{`Prioritas ${r.prioritas}`}</Badge>
: null}
...
rel="noreferrer" className="text-sm text-moss-600 hover:underline">
Buka dokumen
</a>
</div>
))
