...
"next/navigation";
/**
Search box yang men-debounce input dan menaruh nilainya di
query string (?q=...),
supaya hasil pencarian selalu datang dari query Supabase di
server, bukan filter
daftar yang sudah diambil sebelumnya di client.
*/
export function SearchInput({ placeholder = "Cari..." }: {
placeholder?: string }) {
