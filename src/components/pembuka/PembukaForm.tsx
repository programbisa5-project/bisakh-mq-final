...
import type { PembukaMuhadharah } from "@/lib/supabase/database.types";

export function PembukaForm({ existing }: { existing?: PembukaMuhadharah }) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-ink/40 p-4">
          <div className="w-full max-w-lg rounded-lg bg-white p-5">
            ...
            <div className="mt-4 space-y-3">
              ...
              <textarea rows={6} className="w-full rounded-md border border-ink/15 px-3 py-2 text-sm" placeholder="Isi" value={form.isi} onChange={(e) => setForm({ ...form, isi: e.target.value })} />
